  ...
  $.ajax({
    ...
    success: function (data) {
      try {
        ...
        var dirawat = json.active;

        $("#global-kasus").html(rubah(kasus));
        $("#global-pulih").html(rubah(pulih));
        $("#global-meninggal").html(rubah(meninggal));
        $("#global-rawat").html(rubah(dirawat));
      } catch (e) {
...
$.getJSON("https://indonesia-covid-19.mathdro.id/api/provinsi/", function (data) {
  ...
  $.each(data1, function (i, data) {
    ...
    $("#Data-Prov").append("<tr><td>" + i + "</td><td>" + data.provinsi + "</td><td>" + data.kasusPosi + "</td><td>" + data.kasusSemb + "</td><td>" + data.kasusMeni + "</td></tr>");
  });
});
